...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 08, 2026 at 09:29 PM
...
(9, 5, 3, 'rejected', '2026-06-30 05:18:06', '2026-07-03 09:35:36', 1, NULL, 0),
...
(13, 9, 4, 'approved', '2026-06-30 05:18:06', NULL, NULL, NULL, 0),
...
(17, 9, 5, 'approved', '2026-06-30 05:18:06', NULL, NULL, NULL, 1),
...
(25, 9, 7, 'approved', '2026-06-30 05:18:06', NULL, NULL, NULL, 0),
...
(37, 9, 9, 'approved', '2026-07-01 11:55:48', '2026-09-08 14:11:15', 1, NULL, 0);
...
(4, 11, 'Daily Bread - Day 1', '', NULL, '2026-09-08', '2026-09-08 10:03:03', '2026-09-08 10:03:03'),
(5, 11, 'Daily Bread - Day 2', '', NULL, '2026-09-09', '2026-09-08 10:03:03', '2026-09-08 10:03:03'),
(6, 11, 'Daily Bread - Day 3', '', NULL, '2026-09-10', '2026-09-08 10:03:03', '2026-09-08 10:03:03'),
(7, 11, 'Daily Bread - Day 4', '', NULL, '2026-09-11', '2026-09-08 10:03:03', '2026-09-08 10:03:03'),
(8, 11, 'Daily Bread - Day 5', '', NULL, '2026-09-12', '2026-09-08 10:03:03', '2026-09-08 10:03:03'),
(9, 11, 'Daily Bread - Day 6', '', NULL, '2026-09-13', '2026-09-08 10:03:03', '2026-09-08 10:03:03'),
(10, 11, 'Daily Bread - Day 7', '', NULL, '2026-09-14', '2026-09-08 10:03:03', '2026-09-08 10:03:03'),
(11, 11, 'Daily Bread - Day 8', '', NULL, '2026-09-15', '2026-09-08 10:03:03', '2026-09-08 10:03:03');
...
(1, 'Young Adults Retreat', 'Weekend spiritual retreat', '2026-09-01', '2026-09-08', 'Bandung', 'Casual', '08:00:00', 'Villa Lembang', 2, 3, 1, 'active', '2026-06-26 08:06:31', '2026-09-04 04:32:22', NULL, 4000000),
...
(11, 'test', 'aaasldaplpalsdpapslapsld', '2026-09-08', '2026-09-15', 'Yerusalem', NULL, NULL, NULL, 2, 3, 1, 'active', '2026-09-08 10:03:03', '2026-09-08 10:03:03', NULL, 0);
...
(4, 11, '2026-09-08', 'Day 1'),
(5, 11, '2026-09-09', 'Day 2'),
(6, 11, '2026-09-10', 'Day 3'),
(7, 11, '2026-09-11', 'Day 4'),
(8, 11, '2026-09-12', 'Day 5'),
(9, 11, '2026-09-13', 'Day 6'),
(10, 11, '2026-09-14', 'Day 7'),
(11, 11, '2026-09-15', 'Day 8');
...
INSERT INTO `notifications` (`id`, `group_id`, `created_by`, `message`, `created_at`) VALUES
(1, 1, 2, 'Welcome to the retreat. Please arrive on time.', '2026-06-26 08:06:32'),
(2, 1, 3, 'Remember to bring your Bible and notebook.', '2026-06-26 08:06:32'),
(3, 2, 2, 'See you this Saturday at 7 PM.', '2026-06-26 08:06:32');
...
(9, 'austin', 'austin@email.com', '$2y$10$yaUetjXI4MEcV.EF9n0gkuIEQBWuk32B4k1Fk4LwpUWLGQS9ZHjkC', 'Austin', 'Halim', NULL, '085340974407', 'Hello. I Like playing piano', 1, 'user', NULL, NULL, '2026-06-29 15:44:48', '2026-09-04 04:28:34', NULL),
...
ALTER TABLE `notifications`
  ...
  ADD KEY `idx_notifications_sender` (`created_by`);
...
ALTER TABLE `notification_recipients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `nid_nr_fk` (`notification_id`),
...
ALTER TABLE `notifications`
  ...
  ADD CONSTRAINT `fk_notifications_sender` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `notification_recipients`
--
ALTER TABLE `notification_recipients`
  ADD CONSTRAINT `nid_nr_fk` FOREIGN KEY (`notification_id`) REFERENCES `notifications` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `usr_nr_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
